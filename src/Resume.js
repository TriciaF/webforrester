    ...
    <div>
      ...
      <div>
        ...
        <div className='resume-page'>
         ...
         <a className='resume-icon-link' rel='noopener noreferrer' area-hidden='true' target='_blank' href='../images/PForrester_Infographic_Resume.pdf'><svg className="resume-icon" viewBox="0 0 20 20">
       ...
       <a className='resume-icon-link' rel='noopener noreferrer' aria-hidden='true' target='_blank' href='../images/PForrester.pdf'><svg className="resume-icon-resume" viewBox="0 0 20 20">
            ...
            <div className='resume-section'>
            <a className='resume-icon-link' rel='noopener noreferrer' area-hidden='true' target='_blank' href='mailto:palforrester@gmail.com'>
            ...
            <div className='resume-desc'>Email</div>
            <div className='resume-desc'>Address</div>
            <div className='resume-desc'>Phone Number</div>
            </div>
       </div>
       </div> 
    )
