...
class About extends React.Component {
  render() {
    ...
    return(
      ...
      <div className='about-desc-paragraph'>I have recently decided to "go back to my roots" as a software developer, and recently completed a full-stack web development program. This program focused on the latest technologies for building reliable, client/server web-based software. </div>

      <div className='about-desc-paragraph'>I am excited to develop web-based applications and continue learning new technologies. Most of all, I am ready to start having fun and being part of an energetic, well-focused engineering team.
      </div>
      </div>
