...
class About extends React.Component {
  render() {
    ...
    return(
      ...
      <div className='about-desc-paragraph'>I recently decided to "go back to my roots" as a software developer, and completed a full-stack web development program. This program focused on the latest technologies for building reliable, client/server web-based software. </div>
